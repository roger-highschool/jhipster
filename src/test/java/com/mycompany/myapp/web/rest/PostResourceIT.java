...
class PostResourceIT {
    ...
    public static Post createEntity(EntityManager em) {
        Post post = new Post().date(DEFAULT_DATE).title(DEFAULT_TITLE).content(DEFAULT_CONTENT).published(DEFAULT_PUBLISHED);
        return post;
    }
    ...
    public static Post createUpdatedEntity(EntityManager em) {
        Post post = new Post().date(UPDATED_DATE).title(UPDATED_TITLE).content(UPDATED_CONTENT).published(UPDATED_PUBLISHED);
        return post;
    }
    ...
    void createPost() throws Exception {
        ...
        assertThat(testPost.getPublished()).isEqualTo(DEFAULT_PUBLISHED);
    }
    ...
    void putExistingPost() throws Exception {
        ...
        updatedPost.date(UPDATED_DATE).title(UPDATED_TITLE).content(UPDATED_CONTENT).published(UPDATED_PUBLISHED);
        ...
        assertThat(testPost.getPublished()).isEqualTo(UPDATED_PUBLISHED);
    }
    ...
    void partialUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.published(UPDATED_PUBLISHED);
    ...
    void fullUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.date(UPDATED_DATE).title(UPDATED_TITLE).content(UPDATED_CONTENT).published(UPDATED_PUBLISHED);
